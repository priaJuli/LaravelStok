...
class TagCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        //     'label' => "URL Segment (slug)"
        // ], 'update/create/both');
        $this->crud->addField('slug', 'update/create/both'); // a lazy way to add fields: let the CRUD decide what field type it is and set it automatically, along with the field label
